...
timeout -k 5s 5s ./bitree "input=input71.txt;command=command71.txt;output=output71.txt" 1>1.stdcout 2>1.stderr
...
timeout -k 5s 5s ./bitree input=input72.txt command=command72.txt output=output72.txt 1>1.stdcout 2>1.stderr
...
# For test case 3
timeout -k 5s 5s ./bitree "input=input73.txt;command=command73.txt;output=output73.txt" 1>1.stdcout 2>1.stderr
